...
from simplecode.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from simplecode.agent import Agent
    from simplecode.conversation import ConversationManager
    from simplecode.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from simplecode.conversation import ConversationManager as CM
                conv = CM()
