...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from simplecode.agents.fork import ForkError, build_forked_messages
        from simplecode.agents.parser import AgentDef
        from simplecode.agents.tool_filter import resolve_agent_tools
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from simplecode.agents.fork import ForkError, build_forked_messages
        from simplecode.agents.parser import AgentDef
        from simplecode.agents.tool_filter import build_teammate_tools
        from simplecode.agent import Agent as AgentClass
        from simplecode.conversation import ConversationManager
        from simplecode.permissions import (
            DangerousCommandDetector,
        ...
        from simplecode.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from simplecode.teams.spawn_tmux import spawn_tmux_teammate
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from simplecode.client import create_client
