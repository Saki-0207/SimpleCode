...
PROJECT_AGENTS_DIR = ".simplecode/agents"
USER_AGENTS_DIR = "~/.simplecode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("simplecode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from simplecode.agents.parser import parse_frontmatter, _validate_agent_meta
