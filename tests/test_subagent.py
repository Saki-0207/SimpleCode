...
from simplecode.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from simplecode.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from simplecode.agents.trace import TraceManager, TraceNode
from simplecode.agents.task_manager import BackgroundTask, TaskManager
from simplecode.agents.notification import format_task_notification, inject_task_notifications
from simplecode.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".simplecode" / "agents"
...
class TestPermissionMode:
    def test_bypass_mode(self):
        from simplecode.permissions.modes import PermissionMode, mode_decide
...
class TestAgentToolParams:
    def test_required_fields(self):
        from simplecode.tools.agent_tool import AgentToolParams
