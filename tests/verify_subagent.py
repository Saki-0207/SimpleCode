...
from simplecode.agents.fork import FORK_BOILERPLATE_TAG, ForkError, build_forked_messages
...
from simplecode.conversation import ConversationManager, ToolUseBlock
...
def verify_tool_filter(loader: AgentLoader):
    ...
    # 白名单+黑名单组合
    from simplecode.agents.parser import AgentDef
    combo = AgentDef(
        agent_type="combo",
        when_to_use="test",
...
def verify_agent_tool():
    ...
    from simplecode.tools.agent_tool import AgentTool, AgentToolParams
