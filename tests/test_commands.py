...
class TestHelpHandler:
    ...
    async def test_list_all(self) -> None:
        ...
        from simplecode.commands.handlers.help import handle_help
...
class TestPlanDoHandlers:
    ...
    async def test_plan_switches_mode(self) -> None:
        from simplecode.commands.handlers.plan import handle_plan
...
class TestSkillHandler:
    ...
    async def test_skill_list_no_loader(self) -> None:
        from simplecode.commands.handlers.skill import handle_skill
...
class TestStatusHandler:
    ...
    async def test_status_output(self) -> None:
        from simplecode.commands.handlers.status import handle_status
        ...
        assert "SimpleCode 状态" in ui.messages[0]
